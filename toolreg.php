...
@keyframes ani9 {
    ...
    100% {
        transform: translateY(5px);
          ...
          <body>
            <div class="overlay">
                <form  method="POST" action="toolreg.php">
                   <div class="con">
...
<br>     
                ...
                <?php
                    if(isset($_POST['register']))
                    {
                        ...
                        $unq=$phone;
                        $q3="SELECT phone FROM toolcreds where phone='$phone'";
                        ...
                        {
                            $q="INSERT INTO toolcreds
                            VALUES ('$unq','$phone','$password','$fullname')";
                            $r=mysqli_query($con,$q);
                            if($r)
                            {
                                echo "
                               <script>
                               window.location.href = 'toollogin.php'; 
                               </script>";
