...
@keyframes ani9 {
    ...
    100% {
        transform: translateY(5px);
          ...
          <body>
            <div class="overlay">
                <form  method="POST" action="farmerpagelogin.php">
                   <div class="con">
               ...
               <br>
                  ...
                  <br>
                    ...
                    <input type="submit" name="submit" placeholder="Register" style="color:black; background-color:#E3FDF5"class="form-input" >
                   </div>
                </form>
                </div>
                <?php
                    ...
                    $password=$_POST['password'];
                        ...
                        if(mysqli_num_rows($r))
                        {
                            while($row=mysqli_fetch_array($r))
                            {
                               ...
                               $_SESSION['District_Name']=$row['district'];
                                $_SESSION['unq']=$row['unq'];
                                echo "
                                <script>
                                window.location.href = 'nav2.php'; 
                                </script>";
