...
@keyframes ani9 {
    ...
    100% {
        transform: translateY(5px);
          ...
          <body>
            <div class="overlay">
                <form  method="POST" action="busregister.php">
                   <div class="con">
               ...
               <br>
                 ...
                 <br>
                  ...
                  <input class="form-input" name="district" type="text" placeholder="District" id="pwd" required  >
                  <br>
                  <span class="input-item">
                    <i class="fa fa-key"></i>
                   </span>
                  <input class="form-input" name="town" type="text" placeholder="Town" id="pwd" required  >
...
<br>     
                ...
                <?php
                    if(isset($_POST['register']))
                    {
                        ...
                        $town=$_POST['town'];
                        $unq=$phone;
                        $q3="SELECT phone FROM buscreds where phone='$phone'";
                        ...
                        {
                            $q1="INSERT INTO buscreds VALUES ('$unq','$name','$phone','$password','$district','$town')"; 
                            ...
                            if($r1)
                            {
                                echo "
                               <script>
                               window.location.href = 'buslogin.php'; 
                               </script>";
                            } 
                            else
                            {
